        ...
        <div class="app-card-body p-3 p-lg-4">
            ...
            <div class="row gx-5 gy-3">
                <div class="col-12 col-lg-9">
                    ...
                    <div>Kumpulan Fitur Project yang pernah saya buat,semua fitur disini realtime jadi silahkan buka di 2 perangkat berbeda / lebih untuk melihat data berubah secara realtim</div>
                </div>
            </div>
        </div>
    </div>
